...
# Date: 7th Nov 2024
# Description: Proximity-sensor wrapper for the Pioneer 3-DX
# Author: Terry Payne (trp@liv.ac.uk)
# Converts Webots sonar readings into distances used by mapping and navigation.
...
class PioneerSimpleProxSensors:
    ...
    # =====================================================
    # Robot body radius used by the inverse sensor model.
